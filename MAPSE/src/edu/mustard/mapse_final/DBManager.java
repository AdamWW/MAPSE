...
public class DBManager extends SQLiteOpenHelper {
    ...
    public UserSettings getSettings() {
        ...
        Cursor cursor;
		try {
			cursor = db.query(TABLE_SETTINGS, new String[]{KEY_NAME, KEY_EMAIL, KEY_ALARM, KEY_CAT, KEY_THRESH, KEY_FIRSTRUN}, null, null, null, null, null, null);
		
	        if (cursor != null){
	            cursor.moveToFirst();
	 
		        set.setUserName(cursor.getString(cursor.getColumnIndex(KEY_NAME)));
